<?php
/**
  * Template Name: Advance Filtration
 * 
 */
...
.button:not(.components-button):not(.customize-partial-edit-shortcut-button), input[type="button"]:not(.components-button):not(.customize-partial-edit-shortcut-button), input[type="reset"]:not(.components-button):not(.customize-partial-edit-shortcut-button), input[type="submit"]:not(.components-button):not(.customize-partial-edit-shortcut-button)
 ...
 <div class="s002">             
	 ...
	 <form name="importcsv" method="post" action="" enctype="multipart/form-data" class="woof_form" id="importcsv" style="display:none;">
	
		<div class="import-form">	
			<h3><label>Import CSV</label></h3>	
		 </div>		
		 <div class="import-form">			
				  <div class="input-field first-wrap">            
					<input id="search" type="file" name="orderList" placeholder="Import CSV">
				  </div>		  
				  <div class="input-field fifth-wrap">
					<input type= "hidden" id="code_action" name="code_action" value="in-progress" />
					<input type="submit" name="importSubmit" value="Import Excelsheet" class="btn-search">
					<?php /*<input type="submit" name="importSubmit" value="Import Excelsheet" class="btn-search" onclick="statusconfirm(this)">    */ ?>           
				  </div>
				  <div class="input-field right-wrap">
		  ...
		  <div class="import-form">	
			<?php echo ($total_existing_records > 0 ? '<p style="color:#fff ">There are '.$total_existing_records.' records in the database, please delete the records to import the new sheet</p>':'') ;?>
		 </div>
        ...
        <div class="inner-form">	
          <div class="input-field fouth-wrap">
            <div class="icon-wrapp">		
             <p><label style="margin-top: 30px;">Sort By</label>	</p>		
            </div>	
			<div class="icon-wrap">
			...
			<div class="inner-form" id="filteragaindiv" style="display:none;">
				<div class="input-field seventh-wrap">
				   <div class="icon-wrapp">		
					...
					<input id="search" type="text" name="serach_value[]" placeholder="Enter Keyword">
				</div>
